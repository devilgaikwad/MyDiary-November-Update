 ...
 */
public class AllAppointmentFragment2 extends Fragment {
    ...
    public AllAppointmentFragment2() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v= inflater.inflate(R.layout.fragment_all_appointment2, container, false);
        ...
        if(extras != null){
            if(extras.getString("viewDetails","").equals("month")){
                ...
                try{
                    ((MainNavActivity)getActivity()).setActionBarTitle("This Month Entry");
                }catch (Exception e){
                    ((SlidingRootNavActivity)getActivity()).setActionBarTitle("This Month Entry");
                }
            ...
            if(extras.getString("viewDetails","").equals("all")){
                ...
                try{
                    ((MainNavActivity)getActivity()).setActionBarTitle("All Entries");
                }catch (Exception e) {
                    ((SlidingRootNavActivity) getActivity()).setActionBarTitle("All Entries");
                }
            ...
            if(extras.getString("viewDetails","").equals("today")){
                ...
                try{
                    ((MainNavActivity)getActivity()).setActionBarTitle("Todays Entries");
                }catch (Exception e) {
                    ((SlidingRootNavActivity) getActivity()).setActionBarTitle("Todays Entries");
                }
